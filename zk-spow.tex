...
\item \textbf{$R_p$ for Width-24 (resolved).} $R_p = 22$ computed via Plonky3's round number formula~\cite{plonky3}; independent cryptanalytic verification pending. See \S\ref{sec:width24sec}.
