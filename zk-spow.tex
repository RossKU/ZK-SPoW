...
We develop ZK-SPoW as a general framework and instantiate it for \textbf{Kaspa}, a PoW blockchain achieving real-time decentralization (RTD) at 100 blocks per second via the PHANTOM/GhostDAG protocol~\cite{phantom}. Kaspa's planned integration of StarkWare's Stwo STARK prover and its existing ASIC mining ecosystem make it a natural first candidate for PoW/STARK symbiosis.
...
\emph{IACR Cryptology ePrint Archive}, 2018/104, 2018.
