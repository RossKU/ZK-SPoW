...
\midrule
PoW structure & $\mathrm{hash}(\text{ZK proof}) < T$ & Poseidon2 output $< T$ \\
ZK--PoW coupling & External: proof hashed separately & \textbf{Internal}: STARK hash \emph{is} PoW hash \\
ZK overhead & 100\% (every cycle is ZK) & ${\sim}10\%$ (SRAM-bandwidth-limited) \\
