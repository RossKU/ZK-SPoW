...
Proof-of-work (PoW) blockchains expend energy solely for network security. Proof of Useful Work (PoUW) [1, 7, 8, 9] aims to reclaim this cost, but faces a fundamental tension: useful computation is stateful and progressive, yet PoW requires memoryless (progress-free) trials. ZK-based approaches [14]—using STARK proof generation as useful work—inherit this tension at proof-level intervals of tens of milliseconds to seconds, and losing miners' proofs are discarded.
